<template>
  <div>
    ...
    <p class="text-medium-emphasis mb-4">Listen & Repeat + Interview workflow with mic permissions and transcript capture.</p>
    ...
    <v-card rounded="xl" elevation="0" class="pa-4 mb-4">
      ...
      <div class="mt-1">Duration: <strong>{{ duration }}s</strong></div>
